...
""" 
What a serializer does is it will take our model in this case, a room that has 
...
class UpdateRoomSerializer(serializers.ModelSerializer): 
    # Redefined the codefield in my serializer so I won't be referencing codefield in the model where it says
    # unique = True
